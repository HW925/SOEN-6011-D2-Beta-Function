...
\begin{frame}{P5: Tkinter GUI and Exception Recovery}
  ...
  \begin{block}{Implementation and recovery evidence}
    \scriptsize
    \textbf{GUI implemented entirely with Tkinter widgets.}
...
\begin{frame}{P6: README Documentation Evidence}
  \begin{columns}[T,onlytextwidth]
    ...
    \vspace{-0.35em}
    \begin{block}{Numerical design and repository URL}
      \centering

...
\begin{frame}{P5: Tkinter GUI and Exception Recovery}
  \begin{columns}[T,onlytextwidth]
    \column{0.49\linewidth}
    \centering
    \includegraphics[height=3.90cm]{assets/tkinter_gui_domain.png}\\[-0.15em]
    \scriptsize
    \textbf{Domain error:} names \(x\) and states the \(x>0\) correction.

    \column{0.49\linewidth}
    \centering
    \includegraphics[height=3.90cm]{assets/tkinter_gui_nonnumeric.png}\\[-0.15em]
    \scriptsize
...
\begin{frame}{P6: Distributed Version Control Evidence}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{alertblock}{Public repository}
      \scriptsize
      \url{https://github.com/HW925/SOEN-6011-D2-Beta-Function}
    \end{alertblock}
...
\begin{frame}{P6: README Documentation Evidence}
  \begin{columns}[T,onlytextwidth]
    \column{0.49\linewidth}
    \centering
    \includegraphics[height=3.25cm]{assets/readme_scope.png}\\[-0.2em]
    \scriptsize
    \textbf{Scope:} from-scratch boundary, subordinate functions, Tkinter,
    and handled cases.

    \column{0.49\linewidth}
    \centering
    \includegraphics[height=3.25cm]{assets/readme_run_demo.png}\\[-0.2em]
    \scriptsize
    \textbf{Usage:} IDE-independent run command and reproducible demo checks.
  \end{columns}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \centering
    \includegraphics[width=\linewidth,trim=0 160 0 0,clip]
      {assets/readme_design_url.png}

    \column{0.39\linewidth}
    \begin{block}{README coverage}
      \scriptsize
      Numerical method, floating-point limit, repository URL, author, and
      execution instructions are documented alongside the source.
    \end{block}
  \end{columns}
\end{frame}

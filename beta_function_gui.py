"""Tkinter interface for the from-scratch Beta function calculator."""
...
class BetaCalculatorApp:
    ...
    def _configure_style(self):
        ...
        style.configure("Success.TLabel", foreground="#126a31")
    ...
    def _build_interface(self):
        ...
        ttk.Label(input_frame, text="y").grid(row=0, column=2, sticky="w")
        ...
        result_frame = ttk.LabelFrame(main, text="Result", padding=16)
        ...
        ttk.Label(
            main,
            text="Enter: calculate    Esc: clear",
    ...
    def calculate(self, event=None):
        ...
        try:
            ...
            self.result_text.set("Calculation could not be completed.")
            self.status_text.set("Check both values and try again.")
            self.status_label.configure(style="Error.TLabel")
            return
